"""
Django settings for servicesysserver project.
...
SECRET_KEY = 'd(8w^e51n!@*s65ryk!6r+^%qy1--tuk&9ov60tw!sw#6nm7nu'
...
MIDDLEWARE = [
    ...
    # 'django.middleware.csrf.CsrfViewMiddleware',# 默认  为了Forbidden (CSRF cookie not set.):注释掉
...
ROOT_URLCONF = 'servicesysserver.urls'
...
WSGI_APPLICATION = 'servicesysserver.wsgi.application'
